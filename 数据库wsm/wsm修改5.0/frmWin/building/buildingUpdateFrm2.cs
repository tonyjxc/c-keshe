...
namespace frmWin.building
{
    public partial class buildingUpdateFrm2 : Form
    {
        ...
        public void buildDisp() 
        {
            ...
            conn.Open();
            SqlCommand sql = new SqlCommand("select * from building where buildName='"+ ChangeName + "'", conn);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string myinsert = @"update building set dormCount="+sum_room+",dormFloor = " +sum_floor +",buildName = '"+dorm_name +"' where buildName = '"+ this.ChangeName + "'";
