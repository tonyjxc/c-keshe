...
namespace frmWin
{
    public partial class FrmMain : Form
    {
        ...
        private WhatsStuName findstu;
        private void 查找记忆中丢失的同学ToolStripMenuItem_Click(object sender, EventArgs e)

        {
            if (findstu == null || findstu.IsDisposed)
            {
                findstu = new WhatsStuName(jumpinfo);
            }
            Size OldSize = findstu.Size;
            this.Size = new Size(OldSize.Width + 20, OldSize.Height + 70);
            findstu.MdiParent = this;
            findstu.Location = new Point(0, 0); ;
            findstu.Show();
        }
    }
}
