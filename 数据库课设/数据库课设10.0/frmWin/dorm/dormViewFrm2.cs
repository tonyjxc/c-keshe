...
namespace frmWin.dorm
{
    public partial class dormViewFrm2 : Form
    {
        ...
        public void dormDisp()
        {
            ...
            string myinsert = @"select distinct dormID,dormNum,typeName,buildName,dorm.personCount,liveflag,dorm_grade from(dorm left join building on fk_buildid = '" + ChangebuildidName + "')  left join dormtype on typeId = '" + ChangetypeidName + "' where dormNum  = '" + ChangedormName + "' and buildName = '" + ChangebuildName + "'";
