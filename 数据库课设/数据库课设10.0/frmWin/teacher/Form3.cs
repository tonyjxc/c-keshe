...
namespace frmWin.teacher
{
    public partial class Form3 : Form
    {
        ...
        public void dormtypeDisp()
        {
            ...
            string myinsert = @"select teachId,teachName,teachUserName,teachPass,hireDate,edulevel,specialty,tel,sex from teacher where teachId='" + ChangedormtypeName + "'";
            ...
            txthireDate.Text = reader[4].ToString();
            txtedulevel.Text = reader[5].ToString();
            txtspecialty.Text = reader[6].ToString();
            txttel.Text = reader[7].ToString();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string myinsert = @"update teacher set  teachId = " + teachId + ",teachName = '" + teachName + "', teachUserName = " + teachUserName + ",teachPass = " + teachPass + ", sex = '" + sex + "',hireDate = '" + hireDate + "',edulevel = '" + edulevel + "',specialty = '" + specialty + "',tel = " + tel + " where teachId = '" + ChangedormtypeName + "'";
