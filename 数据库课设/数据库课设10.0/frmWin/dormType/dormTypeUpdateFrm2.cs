    ...
    public partial class dormTypeUpdateFrm2 : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                MessageBox.Show("修改不成功，宿舍人数只能为1，2，4，8");
            }
            finally {
                conn.Close();
            }
        ...
        {
            string txtTypeName = ChangedormtypeName;
            SqlConnection conn = new SqlConnection("server=" + MyGlobal.ip + ";database=dormitory;UID=sa;PWD=zyh@197068;Integrated Security=False");
            conn.Open();
            //DELETE FROM dormtype WHERE typeId = 7
            string mydelete = @"DELETE FROM dormtype WHERE typeName = '"+txtTypeName+"'";
            SqlCommand mycom = new SqlCommand(mydelete, conn);
            mycom.ExecuteNonQuery();
