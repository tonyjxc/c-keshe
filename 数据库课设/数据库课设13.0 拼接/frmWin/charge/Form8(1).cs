...
namespace frmWin.charge
{
    public partial class Form8 : Form
    {
        ...
        public void dormtypeDisp()
        {
            ...
            string myinsert = @"select chargeId,chargeName,fk_stuId,fk_teachId,fk_chargeId,unitPrice,payWay from charge,chargeType where fk_stuId='" + ChangedormtypeName + "' and charge.fk_chargeId=chargeType.typeid";
