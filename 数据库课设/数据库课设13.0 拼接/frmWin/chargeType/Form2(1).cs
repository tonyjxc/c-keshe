...
namespace frmWin.chargeType
{
    public partial class Form2 : Form
    {
        ...
        public void LoadTypeInfo()
        {
            ...
            string sqlquery = @"select typeid,typeName,unitPrice,memo from chargeType where typeid='" + dormtypename + "'";
        ...
        private void dgvDormType_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
