...
namespace frmWin.chargeType
{
    public partial class Form3 : Form
    {
        ...
        public void dormtypeDisp()
        {
            ...
            string myinsert = @"select typeid,typeName,unitPrice,memo from chargeType where typeid='" + ChangedormtypeName + "'";
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string myinsert = @"update chargeType set typeid = " + typeid + ",typeName = '" + typeName + "', unitPrice = " + unitPrice + ", memo = '" + memo + "' where typeid = '" + ChangedormtypeName + "'";
