...
namespace frmWin.dorm
{
    public partial class dormUpdateFrm2 : Form
    {
        ...
        public void dormDisp()
        {
            ...
            string myinsert = @"select distinct dormNum,fk_typeId,fk_buildid,personCount,memo,flag from dorm left join building on fk_buildid ='"+ ChangebuildidName + " 'where dormNum = '" + ChangedormName + "' and buildName = '" + ChangebuildName + "'";
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string myinsert = @"update dorm set dormNum = '" + dormnum + "', fk_typeId = " + dormtype + ", fk_buildid = " + buildid + ",personCount=" + personcount + ",memo='" + dormmemo + "',flag='" +dormflag + "' where dormNum = '" + ChangedormName +  "'";
