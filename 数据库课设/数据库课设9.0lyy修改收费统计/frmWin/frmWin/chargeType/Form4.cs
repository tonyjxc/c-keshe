...
namespace frmWin.chargeType
{
    public partial class Form4 : Form
    {
        ...
        public void LoadTypeName()
        {
            ...
            conn.Open();
            SqlCommand sql = new SqlCommand("select typeName from chargeType ", conn);
        ...
        public void LoadTypeInfo()
        {
            ...
            string sqlquery = @"select typeName,unitPrice,memo from chargeType where typeName='" + dormtypename + "'";
