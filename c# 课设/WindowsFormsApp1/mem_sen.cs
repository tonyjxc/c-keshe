...
{
    public partial class mem_sen : Form
    {
        public String temp;
        public int memsenusignid=0;
        public mem_sen(int usingid)
        {


            this.memsenusignid = usingid;
            InitializeComponent();
            //先建立连接
            ...
            //填充表格
            String str = "select sentence,answer from TRANSLATE_SENTENCE where userid = " + memsenusignid;
